...
const nodes = [
  { name:'Core Identity', x:200, y:100 },{ name:'Brand Systems', x:400, y:50 },
  { name:'Web/UI Systems', x:600, y:120 },{ name:'Systems Architecture', x:800, y:80 },
  { name:'Streaming/Overlay', x:1000, y:150 },{ name:'AI Workflows', x:300, y:300 },
  { name:'Game Development', x:500, y:350 },{ name:'Client Experience', x:700, y:300 },
  { name:'Platforms', x:900, y:330 },{ name:'Documentation', x:200, y:500 },
  { name:'Asset Delivery', x:600, y:500 },{ name:'Ideal Clients', x:1000, y:500 }
];
const connections = [[0,1],[1,2],[2,3],[3,4],[0,5],[5,6],[6,7],[7,8],[5,9],[6,10],[8,11]];
...
mapCanvas.addEventListener('mousemove',(e)=>{
  ...
  let hoverIndex=null;
  nodes.forEach((node,i)=>{ if(Math.hypot(mouseX-node.x,mouseY-node.y)<20) hoverIndex=i; });
  drawMap(hoverIndex);
});
